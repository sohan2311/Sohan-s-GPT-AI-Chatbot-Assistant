...
<div style="text-align: center; margin-bottom: 2rem;">
    ...
    <p style="font-size: 1.2rem; color: #666; margin-top: 0.5rem;">
        Powered by Together.ai • {built with 🤍 by Sohan Maity}
    </p>
</div>
""", unsafe_allow_html=True)
...
st.markdown(
    ...
    <div style="text-align: center; color: #666; padding: 1rem;">
        <p>Built with ❤️ using Streamlit & Together.ai | by Sohan Maity ☺️
        <a href="https://github.com/sohan2311" target="_blank">View Source Code in GitHub</a></p>
    </div>
    """, 
    unsafe_allow_html=True
)